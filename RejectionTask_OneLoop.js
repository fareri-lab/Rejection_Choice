...
async function experimentInit() {
  ...
  Welcome = new visual.TextStim({
    win: psychoJS.window,
    name: 'Welcome',
    text: 'Welcome to the Social Media Task!\n\n\nToday you will have the opportunity to share some of your Instagram photos with other participants and receive feedback, as well as a few opportunities to play a lottery for an additional bonus.\n\n\n\n During the course of sharing your photos you will have opportunities to participate in a lottery by guessing if a facedown card is higher or lower than a given number. You can either play the lottery for yourself or have the computer play on your behalf.\n\n\n You will not receive feedback during each lottery trial. At the end of the task, one lottery guess will be selected at random for a chance to earn a monetary bonus and you will be notified of your earnings at the end of the task.\n\n\nPress space to continue.\n',
    font: 'Open Sans',
    units: undefined, 
