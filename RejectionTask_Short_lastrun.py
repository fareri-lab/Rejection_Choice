...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/melanieruiz/Desktop/Rejection_Task 2/RejectionTask_Short_lastrun.py',
...
for thisEntiretaskloop in entiretaskloop:
    ...
    if not TrialNumber%5 == 0: # establishes two blocks per 32 trials
        continueRoutine = False # if not trial 31 or 63, skip routine completely
