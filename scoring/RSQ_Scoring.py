...
pretask_survey = [pretask for pretask in os.listdir() if pretask.startswith('RejectionChoice_PreTask')][0]
...
RSQ_Data =  pd.DataFrame(data=RSQ_average['RSQ_finalscore'])
RSQ_Data.insert(0, 'Prolific_ID',  finaldata['Prolific_ID'])
RSQ_Data.to_csv('selfreportdata_master.csv')
